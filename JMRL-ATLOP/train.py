...
def main():
    ...
    parser.add_argument("--name", default="JMRL", type=str)
    ...
    model = DocREModel(config, model, dataset=args.dataset, num_labels=args.num_labels,
                       lambda_al=args.lambda_al, temperature=args.tau, device=args.device)
    ...
    if args.load_path == "":  # Training
        ...
        pred = report(args, model, dev_features, use_ILP=args.GI)
